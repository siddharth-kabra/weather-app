    ...
    <div className="flex min-h-screen">
      <div className="w-64 border-r border-gray-200 bg-blue-500">
        ...
        <div className="mb-10">
          ...
          <a href="/" className="flex items-center px-6 py-2.5 text-white hover:text-white/[0.5] group">
            Home
          </a>
      ...
      <div className="flex justify-between py-3 px-6 bg-gray-50 border-b space-x-6">
        <form action="" className="w-full max-w-md">
          <div className="relative flex items-center text-gray-400 focus-within:text-gray-600">
           ...
           <input type="text" name="search" placeholder="Search talk" autocomplete="off" aria-label="Search City" className="w-full pr-3 pl-10 py-2 font-semibold placeholder-gray-500 text-black rounded-2xl border-none ring-2 ring-gray-300 focus:ring-gray-500 focus:ring-2" />
          </div>
        </form>
